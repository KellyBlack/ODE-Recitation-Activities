...
\begin{frame}
  ...
  \only<2>{\centerline{\includegraphics[width=6cm]{img/complex16}}}
  \uncover<3->{%
...
\begin{frame}
  ...
  \only<2>{\centerline{\includegraphics[width=6cm]{img/complex2-2i}}}
  \uncover<3->{%
    \begin{eqnarray*}
      ...
      \ifnum\value{clickerQuiz}=1{%
        ...
        %\end{eqnarray*}
          ...
          \begin{tabular}{l@{\hspace{3em}}l@{\hspace{1em}}l}
            A: &  $\sqrt{2}e^{i{\pi}/{12}}$, & $\sqrt{2} e^{i{13\pi}/{12}}$ \\
            B: &  $\sqrt{2}e^{i{\pi}/{6}}$, & $\sqrt{2}e^{i{13\pi}/{6}}$ \\
            C: &  $2e^{i{\pi}/{12}}$, & $2e^{i{13\pi}/{12}}$ \\
            D: &  $2e^{i{\pi}/{6}}$, & $2e^{i{13\pi}/{6}}$ \\ 
          \end{tabular}
