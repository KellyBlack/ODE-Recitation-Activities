  ...
  \frametitle{Clicker Quiz}
      ...
      \ifnum\value{clickerQuiz}=1{%
        ...
        \begin{eqnarray*}
          A \vec{x} & = & \vec{b}.
        \end{eqnarray*}
        We find the determinant of the matrix $A$, and the determinant
        is zero. 
...
\begin{frame}
  ...
  \uncover<4->{Either there is one or infinite solutions. To have
    infinite solutions we need
    \begin{eqnarray*}
      \det\lp A - \lambda I \rp & = & 0.
    \end{eqnarray*}
  }
  \uncover<5->{%
    Find a value for $\lambda$ that makes this true.
  }
\end{frame}
     ...
     \ifnum\value{clickerQuiz}=3{%
       ...
       We have two distinct eigenvalues for a $3 \times 3$
        ...
        \begin{tabular}{ll}
          ...
          B: & There are three. \\
          C: & There could be two or three. \\
          D: & People in France wear lederhosen. \\
       \end{tabular}
