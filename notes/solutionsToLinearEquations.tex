...
\title{Solutions to Linear Systems}
\subtitle{Math 232 - Solving Linear Systems}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    What is the value of $x$ \underline{\redText{and}} $y$?
...
\begin{frame}
  ...
  \uncover<2->{%
    ...
    \begin{eqnarray*}
      ...
      \mathrm{or}~x& = & \frac{2}{5}
    \end{eqnarray*}
  }

  \uncover<3->{%
    The two lines meet at the point $x=\frac{2}{5}$ and
    $y=\frac{14}{5}$.
  }
...
\begin{frame}
  ...
  \end{eqnarray*}
  \uncover<5->{Exactly the same thing only I am using matrices to
...
\begin{frame}
  ...
  \uncover<2-> { If one row comes out with zeros except in the last
    column we say that the system is \redText{\textit{not consistent}.}}
...
\begin{frame}
  ...
  \uncover<1->{If you get all zeros across all of the columns of one
    ...
    is called \redText{\textit{under-determined}.}}
...
\begin{frame}
  ...
  \begin{eqnarray*}
    ...
    & = & \vecThree{4}{0}{0} +   \vecThree{-z\frac{5}{3}}{-z\frac{2}{3}}{z}, \\
...
\begin{frame}
  ...
  \only<2->{The solution is
    \begin{eqnarray*}
      \vec{x} & = & \vec{x}_p + C \vec{x}_h
    \end{eqnarray*}
    where $C$ can be \redText{\textbf{any}} real number.
  }
...
\begin{frame}
  ...
  where both $x_3$ and $x_5$ can be \redText{any} real number.
