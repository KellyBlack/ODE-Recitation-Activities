...
\begin{frame}{Types of Solutions - Real Eigen Values}
...
\begin{frame}{Types of Solutions - Complex Eigen Values}
...
\begin{frame}
  \frametitle{Clicker Quiz}
   ...
   $\lambda_2=-2-\sqrt{3}i$. What is the general behavior of the
   resulting system?
...
\begin{frame}
  ...
  \only<1>{\centerline{\includegraphics[width=5cm]{img/traceDeterminant}}}

  \only<2->{\centerline{\includegraphics[width=5cm]{img/traceDeterminantAnnotated}}}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \column{.33\textwidth}
    \only<5> { Where is it a repelling spiral?
      \begin{eqnarray*}
        D  & > & \frac{T^2}{4}, \\
        -k & > & \frac{1}{4}, \\\
        k  & < & -\frac{1}{4}.
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \only<5-> { Where is it an attracting spiral?
      \begin{eqnarray*}
        D  & > & \frac{T^2}{4}, \\
        -2-k & > & \frac{1}{4}, \\\
        k  & < & -\frac{9}{4}.
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \column{.5\textwidth}
    \only<3> { Where is it a sink/source?
      \begin{eqnarray*}
        D & < & \frac{T^2}{4}, \\
        2 & < & \frac{k^2}{4}, \\
        8 & < & k^2
    ...
    \only<6> { Where is it a repelling spiral?
      \begin{eqnarray*}
        \begin{array}{rcccl}
          0 < & T & < & \sqrt{8}, \\
          0 < & k & < & \sqrt{8}.
...
% LocalWords:  Clarkson pausesection hideothersubsections Eigen
