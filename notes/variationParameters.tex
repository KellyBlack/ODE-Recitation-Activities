...
\begin{frame}{Variation of Parameters}
  ...
  Note that \redText{the coefficient for $y''(t)$ is 1}. If the
  equation is not in this form \blueText{you must take the algebraic
    steps to convert it into this form}.
