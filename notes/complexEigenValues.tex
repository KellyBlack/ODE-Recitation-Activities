...
\begin{frame}
  \frametitle{Clicker Quiz}
   ...
   \ifnum\value{clickerQuiz}=1{%
     Determine the complex conjugate of $1-2i$. \\ [12pt]
  ...
  \ifnum\value{clickerQuiz}=3{%
     Determine the complex conjugate of 
     \begin{eqnarray*}
       \vec{v} = \left[
         \begin{array}{r}
           1-2i \\ 3+4i
   ...
   \begin{tabular}{ll}
     A: & $\bar{\vec{v}} = \left[ \begin{array}{r} 1-2i \\ 3+4i \end{array} \right] $ \\ [12pt]
     B: & $\bar{\vec{v}} = \left[ \begin{array}{r} 1-2i \\ -3-4i \end{array} \right] $ \\ [12pt]
     C: & $\bar{\vec{v}} = \left[ \begin{array}{r} 1+2i \\ 3-4i \end{array} \right] $ \\ [12pt]
     C: & $\bar{\vec{v}} = \left[ \begin{array}{r} 1+2i \\ 3+4i \end{array} \right] $
   \end{tabular}
