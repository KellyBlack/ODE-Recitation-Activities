...
\begin{frame}
  ...
  \begin{eqnarray*}
    x(t) & = & \frac{-F_0}{m\lp\frac{k}{m}-\omega^2\rp} \sin\lp\redText{\lp\omega-\sqrt{\frac{k}{m}}\rp t}\rp
                                                        \sin\lp\blueText{\lp\omega+\sqrt{\frac{k}{m}}\rp t}\rp
  \end{eqnarray*}
...
\begin{frame}{Bonus Problem (continued)}
  ...
  \begin{eqnarray*}
    v_1' & = & \frac{-y_2 f}{y_2' y_1 - y_2 y_1'}, \\
    & = & \frac{-t^{-1} \frac{1}{t^2} \cos(2t)}{-t^{-2} t^{-3} - (-3t^{-4}) t^{-1}}, \\
    & = & \half t^2 \cos(2t).
  \end{eqnarray*}

  \begin{eqnarray*}
    v_2' & = & \frac{y_1 f}{y_2' y_1 - y_2 y_1'}, \\
...
\begin{frame}{Bonus Problem (continued)}
  ...
  \begin{eqnarray*}
    ...
    & & \lp \frac{1}{4} \sin(2t) + C_2 \rp t^{-2}, \\
    & = & \frac{1}{4} t^{-1} \sin(2t) - \frac{1}{8} t^{-3} \sin(2t) + \frac{1}{4} t^{-2} \cos(2t) + C_1 t^{-3} + \\
    & &   \frac{1}{4} t^{-2} \sin(2t) + C_2 t^{-2}. \\
  \end{eqnarray*}
