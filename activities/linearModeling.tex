...
\end{problem}
  ...
  \item Sketch a plot of the slope field for the following
    ...
    \begin{eqnarray*}
      ...
      A(0) & = & 1000.
    \end{eqnarray*}
    Determine the long term solution without solving the differential
    equation. (Sketch the slope field and determine the general
    behavior.) Find the solution to the differential equation. Are
