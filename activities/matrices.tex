...
\end{problem}
  ...
  \actTitle{Determinants and Linear Dependence}
  \begin{problem}
  ...
  \item How many solutions for $\vec{v}$ are there?
    ...
    \item (Optional) Determine whether or not the set of functions
      whose first derivative is zero at $x=0$ is a vector space.
    ...
    \item (Optional) Determine whether or not the set of functions
      that are equal to one at $x=0$ is a vector space.
    ...
    \item (Optional) Are the following vectors linearly independent?
      If not find a way to express one of the vectors in terms of the
      others
